...
dotProduct = Element("dot", [ShaderType.VEC3, ShaderType.VEC3], [ShaderType.FLOAT], "dot_out", "PLACEHOLDER = dot(input1, input2);", ElementType.MAIN_FUNCTION_EXECUTABLE, "vector")

crossProduct = Element("cross", [ShaderType.VEC3, ShaderType.VEC3], [ShaderType.VEC3], "cross_out", "PLACEHOLDER = cross(input1, input2);", ElementType.MAIN_FUNCTION_EXECUTABLE, "vector")

normalize = Element("normalize", [ShaderType.VEC3], [ShaderType.VEC3], "norm_out", "PLACEHOLDER = normalize(input1);", ElementType.MAIN_FUNCTION_EXECUTABLE, "vector")

lengthVec = Element("length", [ShaderType.VEC3], [ShaderType.FLOAT], "len_out", "PLACEHOLDER = length(input1);", ElementType.MAIN_FUNCTION_EXECUTABLE, "vector")
...
sinNode = Element("sin", [ShaderType.FLOAT], [ShaderType.FLOAT], "sin_out", "PLACEHOLDER = sin(input1);", ElementType.MAIN_FUNCTION_EXECUTABLE, "math")

cosNode = Element("cos", [ShaderType.FLOAT], [ShaderType.FLOAT], "cos_out", "PLACEHOLDER = cos(input1);", ElementType.MAIN_FUNCTION_EXECUTABLE, "math")

powNode = Element("pow", [ShaderType.FLOAT, ShaderType.FLOAT], [ShaderType.FLOAT], "pow_out", "PLACEHOLDER = pow(input1, input2);", ElementType.MAIN_FUNCTION_EXECUTABLE, "math")
...
sampleTex = Element("sampleTex", [ShaderType.SAMPLER2D, ShaderType.VEC2], [ShaderType.VEC3], "sample_out", "PLACEHOLDER = texture(input1, input2).rgb;", ElementType.MAIN_FUNCTION_EXECUTABLE, "texture")

texSize = Element("texSize", [ShaderType.SAMPLER2D], [ShaderType.VEC2], "size_out", "PLACEHOLDER = textureSize(input1, 0);", ElementType.MAIN_FUNCTION_EXECUTABLE, "texture")

passthrough = Element("pass", [ShaderType.ANY], [ShaderType.ANY], "pass_out", "PLACEHOLDER = input1;", ElementType.MAIN_FUNCTION_EXECUTABLE, "utility")